...
### 病棟ダッシュボード
病床マップで全患者の移送状態をリアルタイム把握。右側の優先対応一覧で迎えが必要な患者を即座に確認。

![病棟ダッシュボード](docs/img/01_dashboard.png)

### 検査室ビュー
検査室側PCで到着・検査終了をワンクリックで記録。

![検査室ビュー](docs/img/02_examroom.png)
...
```
在床 → 移動中 → 検査室到着 → 検査中 → あと10分 → 迎え要 → 帰棟済
                                                                      ↓
                                                               （キャンセル）
```
